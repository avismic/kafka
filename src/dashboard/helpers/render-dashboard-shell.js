 ...
 * Logic: Renders the structural HTML shell for the dashboard.
 */
import { state as globalState } from "../../core/state.js"; // Import state
...
export function renderDashboardShell(
  ...
  // 1. Get the latest data from global state
  const hotelData = globalState.getHotelData();
  const displayName = hotelData.userName || hotelName;
